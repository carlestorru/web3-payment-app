...
const Landing = () => {
	...
	return (
		<>
			...
			<h1 className='text-7xl bg-white text-blue-500 font-bold rounded-lg py-3'>3Pay</h1>
			<section className='z-10 flex flex-row justify-evenly items-center'>
				...
				<article className='w-[40%] bg-white'>
					<img src="https://cdn.dribbble.com/users/2886970/screenshots/15990765/downloads/light%20dasj.png" alt="dashboard" width="500" height="600" />
				</article>
			</section>
		</main>
		</>
